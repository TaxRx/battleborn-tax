...
GRANT ALL ON rd_roles TO authenticated;
GRANT ALL ON rd_roles TO anon;
...
CREATE POLICY "Users can view their own roles" ON rd_roles
    FOR SELECT USING (true);

DROP POLICY IF EXISTS "Users can insert their own roles" ON rd_roles;
CREATE POLICY "Users can insert their own roles" ON rd_roles
    FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Users can update their own roles" ON rd_roles;
CREATE POLICY "Users can update their own roles" ON rd_roles
    FOR UPDATE USING (true);

DROP POLICY IF EXISTS "Users can delete their own roles" ON rd_roles;
CREATE POLICY "Users can delete their own roles" ON rd_roles
