-- COMPREHENSIVE CLIENT PORTAL TOKEN SYSTEM FIX - UPDATED
...
COMMENT ON FUNCTION generate_portal_token IS 'Generates secure portal access tokens for clients - FULLY FIXED ambiguous token reference - UPDATED for missing columns';
COMMENT ON FUNCTION validate_portal_token IS 'Validates portal tokens and tracks access - Client Portal System - UPDATED for missing columns';
