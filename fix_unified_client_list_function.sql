-- Fix the get_unified_client_list function to use correct column names
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        (acf.wages_income + acf.passive_income + acf.unearned_income + acf.capital_gains) AS total_income,
        acf.filing_status
