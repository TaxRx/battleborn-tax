...
export default function CostSegregationCalculator({
  ...
  useEffect(() => {
    if (onSavingsChange) {
      const totalBenefit = include_fica
      ...
      calculations.federalSavings, calculations.stateSavings, calculations.ficaSavings, include_fica, onSavingsChange]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.5fr,1fr] gap-8 items-start">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2 border-t border-gray-200 pt-4">
            ...
            {include_fica && calculations.ficaSavings > 0 && (
              <div>
            ...
            <div className="border-t border-gray-200 pt-2">
              ...
              <p className="text-4xl font-bold text-emerald-600">
                ${Math.round(include_fica ? calculations.totalSavings : (calculations.totalSavings - calculations.ficaSavings)).toLocaleString()}
              </p>
            </div>
          </div>
        </div>
