    ...
    if (activeStrategy) {
      ...
      if (activeStrategy.id === 'charitable_donation') {
        ...
        onSavingsChange(activeStrategy.id, {
          charitableDonation: {
            donationAmount: details.charitableDonation.donationAmount,
            deductionValue: details.charitableDonation.deductionValue,
            fmvMultiplier: details.charitableDonation.fmvMultiplier,
            totalBenefit: details.charitableDonation.totalBenefit,
            federalSavings: details.charitableDonation.federalSavings,
            stateSavings: details.charitableDonation.stateSavings
          }
        });
