...
const ProposalsTable: React.FC<ProposalsTableProps> = ({ proposals, loading = false }) => {
    ...
    filtered.sort((a, b) => {
      ...
      switch (sortField) {
        ...
        case 'projected_savings':
          aValue = a.projected_savings.annual_savings;
          bValue = b.projected_savings.annual_savings;
          break;
        case 'affiliate_name':
                    ...
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <div className="text-sm text-primary-600">
                          Client: {proposal.client_id.slice(-4).toUpperCase()}
                        </div>
