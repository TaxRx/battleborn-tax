...
export const mockExperts = [
  {
    id: 'expert-001',
    name: 'Michael Chen',
    email: 'michael.chen@taxexperts.com',
    specialties: ['Business Structure', 'Tax Planning'],
    status: 'active',
    commission_rate: 15,
    total_referrals: 12,
    success_rate: 0.92
  },
  {
    ...
    email: 'jennifer.williams@costseg.com',
    specialties: ['Cost Segregation', 'Real Estate Tax'],
    status: 'active',
    commission_rate: 15,
    total_referrals: 8,
    success_rate: 0.88
...
export const mockCommissions = [
  {
    ...
    strategy: 'Family Management Company',
    transaction_value: 28500,
    commission_rate: 15,
    commission_amount: 4275,
    status: 'pending',
